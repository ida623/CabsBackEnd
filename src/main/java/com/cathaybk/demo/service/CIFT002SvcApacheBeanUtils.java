...
public interface CIFT002SvcApacheBeanUtils {
    ResponseTemplate<EmptyTranrs> editInfoApacheBeanUtils(RequestTemplate<CIFT002Tranrq> request) throws DataNotFoundException;
}