...
public interface CIFT002SvcModelMapper {
    ResponseTemplate<EmptyTranrs> editInfoModelMapper(RequestTemplate<CIFT002Tranrq> request) throws DataNotFoundException;
}