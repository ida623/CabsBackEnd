...
public interface CIFT002SvcSpringBeanUtils {
    ResponseTemplate<EmptyTranrs> editInfoSpringBeanUtils(RequestTemplate<CIFT002Tranrq> request) throws DataNotFoundException;
}